...
# When you initialize the classifier, pass the full path to the model file
model_path = 'C:/Users/804529/Downloads/DeepFit-main/DeepFit-main/models/deepfit_classifier_v3.tflite'
